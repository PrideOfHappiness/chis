...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Mar 2024 pada 07.24
...
(1, 'FUJI BRAND AUTOMOTIVE PART', '2024-03-28 06:05:57', '2024-03-28 06:05:57'),
(2, 'FUJI BRAND AUTOMOTIVE PART', '2024-03-28 06:06:54', '2024-03-28 06:06:54');
...
(1, '1234', 'master123', 'Tes Master Data', 'PT. CHIS', 'master', 'Master', 1, 'Active', 'master@test.com', NULL, '$2y$12$GztLTcIolMCQCYglNHyn8eCGE6VOYrKzUqq7VR2IAwtahTQIvpyoe', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(2, '1475', 'admin123', 'Tes Admin Data', 'PT. CHIS', 'Admin', 'Admin', 3, 'Active', 'admin@test.com', NULL, '$2y$12$8W9WERrTYgCwe2MFv1NRLuoH2IRet49AyOkDYoWIueOsXuJBFUcHC', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(3, '2369', 'superadmin123', 'Tes Super Admin Data', 'PT. CHIS', 'Admin', 'Admin', 2, 'Active', 'superadmin@test.com', NULL, '$2y$12$.AqlxFKnTjDd78TE2YUECeO.0A47GjJgdNDKGUvf.7rycUcZ/QPfG', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(4, '1596', 'warehouse', 'Warehouse', 'PT. CHIS', 'pusat', 'Warehouse', 4, 'Active', 'warehouse@test.com', NULL, '$2y$12$f0njby/DKiFqyTpiIHgfNuco0KtsDDgwjqX6jNtgGNIYmMcFqUlvG', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(5, '3214', 'sales123', 'Sales', 'PT. CHIS', 'pusat', 'Sales', 5, 'Active', 'sales@test.com', NULL, '$2y$12$dvkqTlkPJ3mnp9frmTsEoupHXFeHIIQcgPPV7m1BnPSTrGQzbV6di', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(6, '4789', 'production123', 'Production', 'PT. CHIS', 'pusat', 'Production', 6, 'Active', 'production@test.com', NULL, '$2y$12$91NwmYF2z6dhonoiALUAk.b13aPXnyMLIufEzq3uFaVpiXUheEKiy', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36'),
(7, '6357', 'finance123', 'Finance', 'PT. CHIS', 'pusat', 'Finance', 7, 'Active', 'finance@test.com', NULL, '$2y$12$HxAw1eu12nGiPEM/UvnJPuEW.KD1r8n.mJwYNCUo3cW.CPKa9Q6B2', NULL, '2024-03-28 03:04:36', '2024-03-28 03:04:36');
...
(1, 'Master', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(2, 'Super Admin', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(3, 'Admin', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(4, 'Warehouse', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(5, 'Sales', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(6, 'Production', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(7, 'Finance', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(8, 'Back Office', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(9, 'Admin Gudang', '2024-03-28 03:04:33', '2024-03-28 03:04:33'),
(10, 'Warehouse 2', '2024-03-28 03:04:33', '2024-03-28 03:04:33');
...
--
ALTER TABLE `forwarder`
  MODIFY `forwaderID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `product_category`
  MODIFY `productCategoryID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `users`
  MODIFY `userIDNo` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `vehicle_type`
  MODIFY `vehicleTypeID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `warehouse`
--
ALTER TABLE `warehouse`
  MODIFY `warehouseID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
