    ...
    <div class="container">
        <div class="mt-4">
            ...
            <header>
                ...
                <a class="btn btn-success" href="{{ route('subCategoryList.create') }}"> 
                ...
                <table class="table">
                    ...
                    <tbody id="tableBody">
                        @foreach($data as $productCategory)
                            <tr>
                                <td>{{ $productCategory->subCategoryListID }}</td>
...
<script>
    ...
    function fetchSearchResults(searchQuery) {
        ...
        fetch('/admin/subCategoryList/cari', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                const newTableHTML = data.map((sub_category_list, index) => `
                    <tr>
                        <td>${index + 1}</td>
                        <td>${sub_category_list.sub_category}</td>
                    </tr>
                `).join('');
