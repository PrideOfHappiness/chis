    ...
    <div class="container">
        <div class="mt-4">
            ...
            <header>
                ...
                <a class="btn btn-success" href="{{ route('productCategoryList.create') }}"> 
                ...
                <table class="table">
                    ...
                    <tbody id="tableBody">
                        @foreach($data as $productCategory)
                            <tr>
                                <td>{{ $productCategory->productCategoryListID }}</td>
...
<script>
    ...
    function fetchSearchResults(searchQuery) {
        ...
        fetch('/admin/productCategoryList/cari', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                ...
                const newTableHTML = data.map((product_category_list, index) => `
                    <tr>
                        <td>${index + 1}</td>
                        <td>${product_category_list.product_category}</td>
                    </tr>
                `).join('');
