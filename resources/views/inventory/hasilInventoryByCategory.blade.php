                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach($data as $item=>$productData)
                            <tr>
                                <td>{{ $item + 1 }}</td>
                                <td>{{ $productData['product']->productID }}</td>
                                <td>{{ $productData['product']->part_no }}</td>
                                <td>{{ $productData['product']->productName }}</td>
                                <td>{{ $productData['product']->getVehicleTypeFromVehicleType->getMerkFromMerkKendaran->namaKendaraan }} {{$productData['product']->getVehicleTypeFromVehicleType->vehicle_type}}</td>
                                <td>{{ $productData['product']->stock }}</td>
